...
```{r}
y_pred = predict(classifier, newdata = as.matrix(subset(testingSet, select = -c(shot_made_flag))))
y_pred = (y_pred >= 0.5)
...
cm = table(testingSet$shot_made_flag, y_pred)

ctable <- as.table(cm, nrow = 2, byrow = TRUE)
fourfoldplot(ctable, color = c("#CC6666", "#99CC99"),
             conf.level = 0, margin = 1, main = "Confusion Matrix of Shots Made")
```
